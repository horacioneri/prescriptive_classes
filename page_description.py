...
def introduction(i):
    if i == 1:
        ...
        st.write(f'The store has 800 m² available. The store sells products from {n_bu} different Business Units, each with *distinct number of items, margins, dimensions, and space elasticity functions*')
